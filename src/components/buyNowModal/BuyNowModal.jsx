    ...
    return (
        <>
            <Button
                type="button"
                onClick={handleOpen}
                className="w-full px-4 py-3 text-center text-gray-100 bg-cyan-600 border border-transparent dark:border-gray-700 hover:border-pink-500 hover:text-pink-700 hover:bg-pink-100 rounded-xl"
            >
                Buy now
            </Button>
                ...
                <DialogBody className="">
                    <div className="mb-3">
                        <input
                            ...
                            className='bg-pink-50 border border-cyan-200 px-2 py-2 w-full rounded-md outline-none text-cyan-600 placeholder-pink-300'
                        />
                    </div>
                    <div className="mb-3">
                        <input
